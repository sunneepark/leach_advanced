...
elseif isempty(Y31)
    plot(X1,Y1,'g',X1,Y21,'r','Parent',subplot1,'LineWidth',2);
else
    plot(X1,Y1,'g',X1,Y21,'r',X1,Y31,'b','Parent',subplot1,'LineWidth',2);
end
...
elseif isempty(Y31)
     plot(X1,Y2,X1,Y22,'Parent',subplot2,'LineWidth',2);
else
    plot(X1,Y2,X1,Y22,X1,Y32,'Parent',subplot2,'LineWidth',2);
end
...
elseif isempty(Y31)
     plot(X1,Y3,X1,Y23,'Parent',subplot3,'LineWidth',2,'Color',[1 0 0]);
else
    plot(X1,Y3,X1,Y23,X1,Y33,'Parent',subplot3,'LineWidth',2,'Color',[1 0 0]);
end
